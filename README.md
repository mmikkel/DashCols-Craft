...
DashCols makes it easy to add _custom fields_ to element index tables. That’s right, if you ever wanted to display a “featured image” or the like in your index tables – fret no more.
